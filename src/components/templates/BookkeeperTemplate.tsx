...
const STEPS = [
  { number: "01", title: "Connect Your Accounts", description: "Securely link your bank, credit cards, and payment processors. Bank-level 256-bit encryption keeps everything safe.", progress: 33 },
  { number: "02", title: "We Handle the Books", description: "Your dedicated bookkeeper categorizes transactions, reconciles accounts, and keeps everything current -- every single month.", progress: 66 },
  { number: "03", title: "Review and Grow", description: "Get clear monthly reports, actionable insights, and stress-free tax seasons. Focus on your business, not your books.", progress: 100 },
]
...
function WaveDivider({ flip, fill }: { readonly flip?: boolean; readonly fill: string }) {
  return (
    <div style={{ position: "relative", width: "100%", height: "clamp(30px, 5vw, 60px)", overflow: "hidden", lineHeight: 0, transform: flip ? "rotate(180deg)" : "none" }}>
...
function StepProgress({ value }: { readonly value: number }) {
  return (
    <Progress.Root
      value={value}
      style={{
    ...
    <div style={{ minHeight: "100vh", background: "#fff", color: BLACK, fontFamily: bodyFont }}>
      ...
      <section style={{ background: CREAM, position: "relative", overflow: "hidden" }}>
        <div style={{
          ...
          <div style={{ position: "relative", zIndex: 2 }}>
            <FadeIn>
              <p style={{ fontSize: 20, fontWeight: 500, color: BLACK, opacity: 0.75, marginBottom: 16, fontFamily: bodyFont }}>
                Professional Bookkeeping Service
              </p>
            </FadeIn>
            <FadeIn delay={0.1}>
              <h1 style={{
                fontSize: "clamp(36px, 5vw, 80px)", fontWeight: 700, lineHeight: 1.1,
            ...
            <FadeIn delay={0.2}>
              <p style={{ fontSize: "clamp(16px, 2vw, 20px)", color: BLACK, opacity: 0.75, lineHeight: 1.6, maxWidth: 600, marginBottom: 40, letterSpacing: "-0.025em", fontFamily: bodyFont }}>
                {t.hero.subheadline}
              </p>
            </FadeIn>
            <FadeIn delay={0.3}>
            ...
            <FadeIn delay={0.4}>
              <div style={{ display: "flex", gap: 24, alignItems: "center", opacity: 0.6, fontSize: 14 }}>
          ...
          <FadeIn delay={0.2}>
            <div style={{ position: "relative", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "clamp(300px, 40vw, 500px)" }}>
              {/* Yellow circle */}
              <div style={{
                width: "clamp(260px, 30vw, 420px)", height: "clamp(260px, 30vw, 420px)", borderRadius: "50%", background: YELLOW,
              ...
              <div style={{
                ...
                <div style={{ fontSize: 13, color: "#57534e", marginTop: 4 }}>Accuracy Rate</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: 13, color: "#57534e", marginTop: 4 }}>Penalties Avoided</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", gap: 16 }}>
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: "#57534e" }}>Revenue</div>
                  </div>
                  <div style={{ width: 1, background: "#E5E7EB" }} />
                  <div>
                    <div style={{ fontSize: 22, fontWeight: 700, color: "#059669", fontFamily: displayFont }}>$18.2K</div>
                    <div style={{ fontSize: 11, color: "#57534e" }}>Profit</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section style={{ padding: "60px 24px 80px", background: "#fff" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <FadeIn>
            <h2 style={{
              fontSize: "clamp(26px, 3.5vw, 42px)", fontWeight: 700, textAlign: "center",
      ...
      <section style={{ background: CREAM, position: "relative" }}>
        ...
        <div style={{
          ...
          <FadeIn direction="left">
            <div style={{ position: "relative", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "clamp(280px, 30vw, 400px)" }}>
              <div style={{ width: "clamp(220px, 28vw, 360px)", height: "clamp(220px, 28vw, 360px)", borderRadius: "50%", background: YELLOW }} />
              <div style={{
                ...
                <div style={{ fontSize: 13, color: "#57534e", marginBottom: 4 }}>Transactions this month</div>
          ...
          <FadeIn direction="right" delay={0.1}>
            <div>
              <h2 style={{ fontSize: "clamp(28px, 3.5vw, 42px)", fontWeight: 700, fontFamily: displayFont, lineHeight: 1.26, marginBottom: 20, color: BLACK }}>
                Stop drowning in receipts and start growing
              </h2>
              <p style={{ fontSize: 16, color: "#57534e", lineHeight: 1.75, marginBottom: 24 }}>
          ...
          <div style={{
            ...
            {t.stats.map(stat => (
              <div key={stat.label} style={{ textAlign: "center" }}>
                <div style={{ fontSize: "clamp(28px, 3vw, 36px)", fontWeight: 700, color: BLUE, fontFamily: displayFont }}>
                  <CountUp end={stat.value} prefix={stat.prefix} suffix={stat.suffix} />
                </div>
                <div style={{ fontSize: 14, color: "#57534e", marginTop: 6 }}>{stat.label}</div>
              </div>
            ))}
          </div>
        </FadeIn>
      ...
      {/* How It Works -- 3 numbered steps with progress bars */}
      <section style={{ padding: "clamp(48px, 6vw, 80px) 24px", background: "#fff" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <FadeIn>
            <h2 style={{ fontSize: "clamp(28px, 3.5vw, 42px)", fontWeight: 700, fontFamily: displayFont, textAlign: "center", marginBottom: 64, lineHeight: 1.26, color: BLACK }}>
            ...
            {STEPS.map((step, i) => (
              <FadeIn key={step.number} delay={i * 0.15}>
                <div style={{ textAlign: "center" }}>
                  ...
                  <p style={{ fontSize: 15, color: "#57534e", lineHeight: 1.7 }}>{step.description}</p>
                  <StepProgress value={step.progress} />
                  <div style={{ fontSize: 12, color: "#57534e", marginTop: 6, fontWeight: 500 }}>
                    Step {i + 1} of 3
                  </div>
                </div>
              </FadeIn>
      ...
      <section style={{ background: BLUE, padding: "clamp(64px, 8vw, 100px) 24px", position: "relative" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <FadeIn>
            <h2 style={{
              fontSize: "clamp(28px, 3.5vw, 42px)", fontWeight: 700, fontFamily: displayFont, textAlign: "center",
          ...
          <FadeIn delay={0.15}>
            <div style={{
              background: "#fff", borderRadius: 12, padding: "clamp(24px, 4vw, 48px) clamp(20px, 4vw, 56px)",
                ...
                {t.testimonials.map((testimonial, i) => (
                  <div key={testimonial.name} style={{
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 13, color: "#57534e" }}>{testimonial.role}, {testimonial.company}</div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <FadeIn delay={0.3}>
            <div style={{ textAlign: "center", marginTop: 48 }}>
              <p style={{ fontSize: 16, color: "rgba(255,255,255,0.8)", marginBottom: 20 }}>Trusted by 500+ business owners</p>
              <div style={{ display: "flex", justifyContent: "center", gap: 40, flexWrap: "wrap" }}>
                {INTEGRATIONS.map(name => (
                  <span key={name} style={{ fontSize: 15, fontWeight: 700, color: "rgba(255,255,255,0.65)" }}>{name}</span>
                ))}
              </div>
            </div>
          </FadeIn>
      ...
      {/* Pricing with Radix Tabs for Monthly/Annual toggle */}
      {t.pricing && (
        <section style={{ padding: "clamp(48px, 6vw, 80px) 24px", background: "#fff" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            <FadeIn>
              <div style={{ textAlign: "center", marginBottom: 40 }}>
                <h2 style={{ fontSize: "clamp(28px, 3.5vw, 42px)", fontWeight: 700, fontFamily: displayFont, color: BLACK, marginBottom: 16 }}>
                  Simple, transparent pricing
                </h2>
                <p style={{ fontSize: 16, color: "#57534e", maxWidth: 500, margin: "0 auto 32px" }}>
                  Choose the plan that fits your business. No hidden fees.
                </p>
              </div>
            </FadeIn>

            <Tabs.Root value={billingCycle} onValueChange={setBillingCycle}>
              <FadeIn delay={0.05}>
                  ...
                  <Tabs.List style={{
                    ...
                    <Tabs.Trigger
                      ...
                      style={{
                        ...
                        color: billingCycle === "monthly" ? BLACK : "#57534e",
                    ...
                    <Tabs.Trigger
                      ...
                      style={{
                        ...
                        color: billingCycle === "annual" ? BLACK : "#57534e",
              ...
              <Tabs.Content value="annual">
                <PricingTable
                  tiers={t.pricing.map(tier => {
                    const priceStr = tier.price.replace(/[^0-9.]/g, "")
                    const priceNum = parseFloat(priceStr)
                    const annualPrice = isNaN(priceNum) ? tier.price : `$${Math.round(priceNum * 0.8)}`
                    return {
                      ...tier,
                      price: annualPrice,
      ...
      <section style={{ background: YELLOW, padding: "clamp(64px, 8vw, 100px) 24px", position: "relative", overflow: "hidden", textAlign: "center" }}>
        ...
        <div style={{ maxWidth: 464, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <FadeIn>
            <h2 style={{ fontSize: "clamp(28px, 3.5vw, 42px)", fontWeight: 700, fontFamily: displayFont, lineHeight: 1.26, color: BLACK, marginBottom: 16 }}>
              Ready for stress-free books?
            </h2>
          </FadeIn>
          <FadeIn delay={0.1}>
            <p style={{ fontSize: 16, color: BLACK, opacity: 0.75, lineHeight: 1.62, marginBottom: 32 }}>
            ...
            <div style={{ display: "flex", gap: 0, background: "#fff", borderRadius: 10, overflow: "hidden", boxShadow: "0 4px 20px rgba(0,0,0,0.1)" }}>
              <input
                ...
                style={{
                  ...
                  outline: "none", fontFamily: bodyFont, color: "#57534e", background: "#fff",
                  minWidth: 0,
                }}
              />
              <button style={{
          ...
          <FadeIn delay={0.3}>
            <p style={{ fontSize: 14, color: BLACK, opacity: 0.6, marginTop: 16 }}>
      ...
      <footer style={{ background: "#fff", padding: "48px 24px", borderTop: "1px solid #E5E7EB" }}>
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 13, color: "#57534e" }}>Partner Portal Templates</div>
          </div>
          <div style={{ display: "flex", gap: 32, flexWrap: "wrap" }}>
            {["About", "Services", "Pricing", "Contact"].map(link => (
              <span key={link} style={{ fontSize: 14, color: "#57534e", cursor: "pointer" }}>{link}</span>
            ))}
          </div>
        </div>
      </footer>
