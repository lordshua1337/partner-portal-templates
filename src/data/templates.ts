...
export const TEMPLATES: readonly TemplateConfig[] = [
  ...
  },
  {
    ...
    category: 'Professional Services',
    description: 'Dark premium design with golden accents on black. Space Grotesk headlines, dramatic section contrasts, geometric CTA shapes. Inspired by cyber-security layouts.',
  ...
  },
  {
    ...
    category: 'Professional Services',
    description: 'Clean white design with electric lime accent sections. Plus Jakarta Sans headlines, dashboard card previews, dark feature blocks. Inspired by fintech layouts.',
  ...
  },
  {
    ...
    name: 'CPA / Accounting',
    category: 'Professional Services',
    description: 'Organized, friendly design with rounded Rubik font and soft lavender accents. Alternating feature sections, structured pricing, charcoal footer. Inspired by modern SaaS layouts.',
  ...
  },
  {
    ...
    name: 'Bookkeeper',
    category: 'Professional Services',
    description: 'Warm, friendly design with bold blue accents and golden CTAs. Wavy dividers, yellow circles, and staggered cards. Inspired by modern SaaS time-tracking layouts.',
    useCase: 'Bookkeeping services, virtual bookkeepers, accounting support, small business finance',
    fonts: { display: 'Public Sans', body: 'Inter' },
    colors: {
      primary: '#2B59FF',
      primaryLight: '#4B73FF',
      accent: '#FFC947',
  ...
  },
  {
    ...
    category: 'Professional Services',
    description: 'Bold strategic design with tall Darker Grotesque headlines on electric purple. Black hero with purple glow orbs, 2x2 service grid on purple bg, cool gray sections.',
  ...
  },
  {
    ...
    description: 'Editorial magazine feel with Urbanist headlines and neon yellow-green accents. Black/white section rhythm, oversized typography, star decorations. Inspired by digital agency layouts.',
    useCase: 'Onboarding, product demos, guided setup flows, template selection wizards',
    fonts: { display: 'Urbanist', body: 'Inter' },
    colors: {
      primary: '#12141D',
      primaryLight: '#1E2028',
      accent: '#F1FE92',
